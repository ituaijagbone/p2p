                    ...
                    case 1:
                        ...
                        for (int j = 0; j < names.size(); j++) {
                            ...
                            for (int i = 0; i < 1000; i++) {
                                ...
                                ppServer.query(new ArrayList<String>(), fileName, 4);
...
/**
 * Update array that holds peer file names when change is made to directory
 */
...
public class PeerApp {
    public static void main(String args[]) {
        ...
        *   Command line arguments go here
        ...
        peerService.register(peerId, fileNames, thisServerPort, neighbors, "localhost");
        PeerServer peerServer = new PeerServer(peerService, "" + thisServerPort, thisServerPort);
        peerServer.run();
        PeerToPeerServer ppServer = new PeerToPeerServer("" + thisServerPort, "localhost", thisServerPort);
